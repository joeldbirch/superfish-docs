    ...
    <div className="section  content">
			...
			<ol className="steps">
				<li className="step-one">
					...
					<pre><code className="language-markup">&lt;link href="superfish.css" rel="stylesheet" media="screen"&gt;</code></pre>
				</li>
				<li className="step-two">
					Link to the superfish.js file (after including jQuery) using a script tag in the head of your document.
							<pre><code className="language-markup">&lt;script src="jQuery.js"&gt;&lt;/script&gt;
&lt;script src="superfish.js"&gt;&lt;/script&gt;</code></pre>
				</li>
				<li className="step-three">
			Call superfish() on the containing <abbr title="unordered list">ul</abbr> element.
			<pre><code className="language-markup">&lt;script&gt;{`
