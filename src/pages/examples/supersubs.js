...
const IndexPage = () => (
  <Layout>
    <SEO title="Supersubs Menu Example" description="Superfish menu example with Supersubs to control submenu width." keywords={[`jQuery`, `Superfish`, `Menu`, `Plugin`, `Example`, `Supersubs`]} />
